                ...
                <div className={'flex gap-2 sm:gap-14 sm:px-14 flex-col'}>
                    <div className="pt-20 mb-20 px-8 sm:px-0 max-w-4xl mx-auto">
                        ...
                        <Text className={'my-5'}>
                            ...
                            С devops-ами запустил процессы бекапов БД, S3 compatible storage и инфраструктуры разработки,
                        ...
                        <div className={'my-5'}>
                            ...
                            <ul className={'list-disc list-inside'}>
                                <li className={'my-1 text-lg'}>Генерация рекламных объявлений на основе xml/json
                                    ...
                                    крупные). В рамках этого проекта реализовал механизм шардинга много терабайтного
                                    PostgreSQL на
                                ...
                                <li className={'my-1 text-lg'}>Разрабатывал ETL систему для скачивания статистики и
                                    ...
                                    проекта построил распределенную систему очередей и вместе с командой удалось
                                    построить
