    ...
    return (
        <main className="bg-site min-h-[600px]">
            <div className="mx-auto relative">
                        ...
                        <div className="basis-1/2 text-center sm:text-left relative">
                            <div className="px-10 sm:px-14 py-6 bg-site" data-testid="home.header">
                                ...
                                <h3 className="text-base sm:text-2xl py-6">
                                    c
                                    &nbsp;
                                    <span className="text-purple-500">Артуром Геращенко</span>
                                </h3>
                ...
                <div className={'bg-gradient-to-r from-violet-950 via-purple-900 to-violet-950' +
                ' text-site p-8 sm:p-20'}>
                    <div className="max-w-4xl mx-auto">
                        <div className={'bg-white opacity-70 rounded-xl shadow-lg p-8'}>
                            <Text className={'my-2'} color={'black'} align={'center'}>
                    ...
                    <div className="pt-20 mb-20 px-8 sm:px-0 max-w-4xl mx-auto">
                        ...
                        <ul className={'list-disc list-inside'}>
                            <li className={'my-1 text-lg'}>Генерация рекламных объявлений на основе xml/json
                                товарного фида клиента и управление рекламой через API. Работал как с отечественными
                                площадками (Яндекс.Директ, ВКонтакте/VK), так и зарубежными системами (Google Ads и
                                другие крупные). В рамках этого проекта реализовал механизм шардинга много
                                терабайтного PostgreSQL на несколько серверов + посхемное разбиение,
                                что позволило на порядки ускорить работу сервиса.
                            </li>
                            <li className={'my-1 text-lg'}>Разрабатывал ETL систему для скачивания статистики и
                                хранения больших данных в ClickHouse и Google BigQuery, а также загрузки данных
                                о транзакциях в аналитические системы типа Яндекс.Метрика, Google Analytics
                                или напрямую в базу данных клиента. В рамках этого проекта построил распределенную
                                систему очередей и вместе с командой удалось построить внутренний python фреймворк,
                                который позволял гонять много сотен гигабайт в сутки, практически
                                не имея оверхеда по памяти за счет использования генераторов в ядре перегонки
                                данных.
                            </li>
                        </ul>
                        ...
                        <Text className={'my-5'}>
                            ...
                            review, авто-тесты (unit, e2e на selenium), ручные тесты силами QA инженеров.
                            С devops-ами запустил процессы бекапов БД, S3 compatible storage и инфраструктуры
                            разработки, а также внешний и внутренний мониторинг.
                        </Text>

                        <Text className={'my-5'}>
                            В работе придерживаюсь стиля управления мягкой силы.
                            Понимаю, за что бизнес платит деньги и организую работу на результат.

                            Использую менторинг, мотивационные мероприятия,
                            one2one-ы, дейли/планерки, ректроспективы, ИПР-ы, code review, design review и пр.
                            Умею расставлять приоритеты, стараюсь соблюдать баланс,
                            защищая не только бизнес, например, от ненужного в данный момент рефакторинга и
                            прочих активностей, но и команду он бесконечно нарастающего техдолга.
                        </Text>
                    </div>
                </div>
                ...
                <div className={'bg-gray-800 text-site pt-16 sm:pt-20 pb-8'}>
                    <div className="mb-8 px-8 sm:px-0 max-w-4xl mx-auto">
                        ...
                        <Text color={'white'}>Это часть проектов, над которыми я работал в последние годы</Text>
                ...
                <div className={'flex gap-2 sm:gap-14 px-14 flex-col'}>
                    <div className="pt-20 mb-20 px-8 sm:px-0 max-w-4xl mx-auto">
                        ...
                        <Text align={'center'}>
                            ...
                            <Link className={'text-purple-500'} href={'https://t.me/arturgspb'}
                                  target={'_blank'}>Телеграм</Link>{' '}
                            или на почту{' '}
                            <Link className={'text-purple-500'} href={'mailto:arturgspb@gmail.com'}
                                  target={'_blank'}>arturgspb@gmail.com</Link>,
                            если есть вопросы, предложения или, например, вы считаете, что на сайт надо добавить
                            какую-то информацию - я буду очень рад.
